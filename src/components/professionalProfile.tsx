...
const highlightBadges = [
  {
    ...
    icon: <HiOutlineChartBar className="h-6 w-6 text-accent" />,
  },
  {
    label: "Drone + GNSS",
    detail: "Photogrammetry paired with precision control",
    icon: <HiOutlineSparkles className="h-6 w-6 text-accent" />,
  },
  {
    label: "International Reach",
    detail: "World Bank, airport, and regional programs",
    icon: <HiOutlineGlobeAlt className="h-6 w-6 text-accent" />,
  },
];
...
const ProfessionalProfile = () => (
  <section
    id="profile"
    data-reveal
    className="reveal relative my-16 overflow-hidden rounded-[32px] border border-white/10 bg-gradient-to-br from-brand-900 via-brand-900 to-brand-800 px-4 py-16 text-white shadow-[0_35px_70px_rgba(2,6,23,0.75)] lg:px-12"
  >
    ...
    <div className="relative mx-auto flex max-w-6xl flex-col gap-12">
      ...
      <div className="grid gap-8 lg:grid-cols-[1.7fr_1.3fr]">
        <article className="rounded-3xl border border-white/20 bg-slate-950/95 p-6 shadow-[0_30px_70px_rgba(2,6,23,0.75)]">
          <h3 className="text-2xl font-semibold text-white">Core Technical Expertise</h3>
          ...
          <ul className="mt-4 grid gap-3 text-base text-white/80">
        ...
        <article className="rounded-3xl border border-white/20 bg-slate-950/95 p-6 shadow-[0_30px_70px_rgba(2,6,23,0.75)]">
          <h3 className="text-2xl font-semibold text-white">Professional Impact</h3>
          <p className="mt-2 text-base text-white/70">
      ...
      <div className="grid gap-6 lg:grid-cols-[1fr_1fr]">
        <article className="rounded-3xl border border-white/20 bg-slate-950/95 p-6 shadow-[0_30px_70px_rgba(2,6,23,0.75)]">
          <h3 className="text-3xl font-semibold text-white">Major Project Contributions</h3>
          <div className="mt-5 space-y-4">
            {projectEntries.map((project) => (
              <div
                key={project.title}
                className="rounded-2xl border border-white/10 bg-slate-950/80 p-4 text-base shadow-sm shadow-black/40"
              >
        ...
        <article className="rounded-3xl border border-white/20 bg-slate-950/95 p-6 shadow-[0_30px_70px_rgba(2,6,23,0.75)]">
          ...
          <button
            type="button"
            className="mt-6 w-full rounded-2xl border border-transparent bg-accent py-3 text-sm font-semibold uppercase tracking-[0.4em] text-slate-900 shadow-lg shadow-[0_20px_60px_rgba(201,168,106,0.35)] transition hover:-translate-y-0.5 hover:brightness-110"
          >
