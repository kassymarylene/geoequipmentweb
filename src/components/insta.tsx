    ...
    <div className="relative p-4 mb-4">
      ...
      <div className="relative ">
        <div className="flex flex-col justify-center items-center">
          <p className="text-9xl sm:text-[160px] text-white opacity-5 font-black text-center z-0 absolute top-0 left-0 w-full uppercase dark:text-white">
            instagram
          </p>
          <p className="text-2xl sm:text-4xl text-white font-bold text-center z-20 relative capitalize mt-[55px] dark:text-gray-300">
            checkout what our customers shared{' '}
            <span className="normal-case text-accent">#homes</span>
          </p>
        </div>
      </div>
